...
if (!empty($_SESSION['username'])) {
    header('location: html/ltr/route.php?module=home');
}
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div>
                    ...
                    <br>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" action="html/process/userRegister.php" method="POST">
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="nama" class="form-control form-control-lg" placeholder="Full Name  " aria-label="Full Name" aria-describedby="basic-addon1" required>
                                </div>
                                <!-- email -->
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
