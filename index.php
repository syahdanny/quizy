<?php 
    ...
    if (!empty($_SESSION['username'])) {
        header('location: html/ltr/route.php?module=userHome');
    }
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <br>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="html/process/userLogin.php" method="POST">
                        ...
                        <div class="row border-top border-secondary">
                            ...
                            <br>
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <a href="register.php" class="btn btn-info" id="to-recover" type="button">Register</a>
